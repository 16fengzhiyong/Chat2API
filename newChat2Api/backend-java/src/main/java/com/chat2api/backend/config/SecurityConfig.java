...
import com.chat2api.backend.security.PasswordChangeRequiredFilter;
...
public class SecurityConfig {
    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter, PasswordChangeRequiredFilter passwordChangeRequiredFilter, RateLimitFilter rateLimitFilter, RequestBodyLimitFilter requestBodyLimitFilter, ObjectMapper objectMapper) throws Exception {
        ...
        http.addFilterAfter(passwordChangeRequiredFilter, JwtAuthenticationFilter.class);
        return http.build();
    }
