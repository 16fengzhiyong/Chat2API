...
@RestController
@RequestMapping("/api/load-balance/config")
public class LoadBalanceConfigController {
    private static final String CONFIG_KEY = "loadBalance";
    private final AppConfigRepository appConfigRepository;
    private final ObjectMapper objectMapper;

    public LoadBalanceConfigController(AppConfigRepository appConfigRepository, ObjectMapper objectMapper) {
    ...
    private Map<String, Object> defaultConfig() {
        ...
        config.put("strategy", "round_robin");
        config.put("weights", new LinkedHashMap<>());
        return config;
    }
